...
\chead{\scriptsize \textit{References -- \acs{Risk: Dynamic}}}
...
\begin{filecontents}{risk-dynamic.bib}
    @article{
        nie24a,
    ...
    @article{
        siu94a,
        author = {Siu, N.},
        title = {{Risk assessment for dynamic system: An overview}},
        journal = {Reliability Engineering \& System Safety},
        volume = {43},
        pages = {43},
        year = {1994}
    ...
    @incollection{
        ...
        booktitle = {Advanced Methods of Risk Assessment and Management},series = {Methods in Chemical Process Safety},
        publisher = {Elsevier},
        volume = {4},
        pages = {35},
        year = {2020}
